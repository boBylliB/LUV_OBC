...
uint8_t begin_SPI(BNO08x* bno08x, uint8_t cs_pin, uint8_t int_pin, uint8_t rst_pin, int32_t sensor_id = 0);
void hardwareReset(BNO08x* bno08x);
uint8_t wasReset(BNO08x* bno08x);
uint8_t enableReport(BNO08x* bno08x, sh2_SensorId_t sensor, uint32_t interval_us = 10000);
